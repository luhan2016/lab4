...
try:
    ...
    def vote_byzantine():
        ...
        propagate_byzantine_vote_to_vessels(byzantine_vote)
        propagate_byzantine_vectors_to_vessels(byzantine_vectors)
    ...
    def propagation_received_vector(precede_id):
        ...
        try:
            body = request.body.read()
            print "\n\n\n\npropagation_received_vector, body is: ",body
